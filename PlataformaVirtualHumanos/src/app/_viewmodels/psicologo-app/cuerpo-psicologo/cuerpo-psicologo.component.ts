...
export class CuerpoPsicologoComponent implements OnInit,AfterViewInit {
  ...
  constructor(private compiler: Compiler,private psicologoNavegacionService:PsicologoNavigationService,private autenticacionService:AuthenticationService,private router:Router) { }
