...
export class MisMetasDAO
{
    ...
    async listarMetas(){
        ...
        return await this.coneccionServidor.coneccionServidor(parametros,"/pacientes/listarMetas");
    }
    ...
    async read_Meta(id_Meta:any){
        ...
        var respuestaHTTP_meta= await this.coneccionServidor.coneccionServidor(parametros,"/pacientes/read_meta");
    ...
    async create_Meta(titulo:any,fechaDeRegistro:any,fechaDeLaMeta:any,prioridad:any,descripcion:any){
        ...
        var parametros={
            "carnetDeIdentidad": this.carnetDeIdentidadPaciente,
            "meta":nuevaMeta};
        var respuesta=await this.coneccionServidor.coneccionServidor(parametros,"/pacientes/create_meta")
        return respuesta;
    }
    ...
    async update_Meta(id:any,titulo:any,fechaDeRegistro:any,fechaDeLaMeta:any,prioridad:any,descripcion:any){
        ...
        var parametros={
            "carnetDeIdentidad": this.carnetDeIdentidadPaciente,
            "meta":modificarMeta};
        var respuesta=await this.coneccionServidor.coneccionServidor(parametros,"/pacientes/update_meta")
        return respuesta;
    ...
    async delete_Meta(id_Meta:any){
        var parametros={
            "carnetDeIdentidad": this.carnetDeIdentidadPaciente,
            "id":id_Meta}
        return await this.coneccionServidor.coneccionServidor(parametros,"/pacientes/delete_meta");
    }
