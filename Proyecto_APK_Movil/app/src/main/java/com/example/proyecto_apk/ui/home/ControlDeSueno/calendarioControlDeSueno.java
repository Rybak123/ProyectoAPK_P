...
public class calendarioControlDeSueno extends Fragment {
  ...
  private CalendarView calendarView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      root=inflater.inflate(R.layout.fragment_calendario_control_de_sueno, container, false);
      btn_volver=root.findViewById(R.id.id_CalendarioDeSueno_volver);
      calendarView = (CalendarView) root.findViewById(R.id.calendarView_ControlDeSueno);
